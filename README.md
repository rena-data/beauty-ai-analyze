...
| 날짜 | 내용 |
|------|------|
| 2026.05.06 | MVP 출시 - 퍼스널컬러 분석, 제품 추천, 리포트 다운로드 |
| 2026.05.06 | 실제 제품 데이터 연동 (올리브영 80개 + 무신사 37개) |
| 2026.05.06 | 성별별 제품 추천 (남성/여성/유니섹스) |
| 2026.05.06 | GA4 연동, 개인정보처리방침, 쿠키 동의 |
| 2026.05.06 | 문의하기 → Google Sheets 연동 |
| 2026.05.06 | Render 배포 + UptimeRobot 슬립 방지 |
| 2026.05.06 | 프롬프트 정확도 개선 (확신도 차등, 연예인 레퍼런스) |
| 2026.05.06 | API 호출 최적화 (얼굴 확인 통합, 호출 50% 절감) |
| 2026.05.06 | 스타일링 hex 코드 → 컬러칩 자동 변환 |
